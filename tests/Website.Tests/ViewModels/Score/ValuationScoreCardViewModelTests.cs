namespace QOAM.Website.Tests.ViewModels.Score
{
    ...
    public class ValuationScoreCardViewModelTests
    {
        [Fact]
        public void NotValidWhenQuestionScoresIsNull()
        {
            // Arrange
            var model = new ValuationScoreCardViewModel { QuestionScores = null };
        ...
        {
            // Arrange
            var model = new ValuationScoreCardViewModel { QuestionScores = new List<QuestionScoreViewModel>() };
        ...
        {
            // Arrange
            var model = new ValuationScoreCardViewModel
            {
