    ...
    public static class SubmissionPageLinkStubs
    {
        ...
        { 
            var list = new List<SubmissionPageLink>
            {
                ...
                new SubmissionPageLink { ISSN = "1687-7675", Url = "http://www.hindawi.com/journals/aess/submission" }
            };
        ...
        public static List<Journal> Journals()
        {
            return new List<Journal>
            {
                ...
                new Journal { Id = 4, ISSN = "1687-7675", Link = "http://www.hindawi.com/journals/aess" }
            };
        }
    }
}