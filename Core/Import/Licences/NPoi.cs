...
namespace QOAM.Core.Import.Licences
{
    ...
    {
        public static ISheet GetFirstSheet(Stream input)
        {
            return GetWorkbook(input).GetSheetAt(0);
        }

        public static IWorkbook GetWorkbook(Stream input)
        {
        ...
        //public static string GetCellValueAsString(this IRow row, IColumn column)
        //{
        //    if (row == null)
        //    {
        //        return null;
        ...
        {
            return row?.Cells == null || row.Cells.All(c => c.IsBlank());
        }
